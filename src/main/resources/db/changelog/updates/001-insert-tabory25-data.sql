...
INSERT INTO reg_event (id, created_at, uuid, event_type, name, details, place, reg_end_at, reg_start_at, image_url, discount_type) VALUES
...
INSERT INTO reg_event_term (id, start_at, end_at, capacity, deposit, price, event_id)
    VALUES (nextval('seq_event_term_id'), '2025-07-08 08:00:00', '2025-07-08 16:00:00', 20, 0, 50, (SELECT id FROM reg_event WHERE uuid = 'a8084393-29af-4aaa-9f75-32b93b53e5a0'));
INSERT INTO reg_event_term (id, start_at, end_at, capacity, deposit, price, event_id)
    VALUES (nextval('seq_event_term_id'), '2025-07-10 08:00:00', '2025-07-10 16:00:00', 20, 0, 50, (SELECT id FROM reg_event WHERE uuid = 'a8084393-29af-4aaa-9f75-32b93b53e5a0'));

-- Letný Camp 2025
INSERT INTO reg_event_term (id, start_at, end_at, capacity, deposit, price, event_id)
    VALUES (nextval('seq_event_term_id'), '2025-08-17 12:30:00', '2025-08-22 12:00:00', 25, 100, 340, (SELECT id FROM reg_event WHERE uuid = '15aec1f8-0679-4de7-8774-b9e7c80697f8'));
